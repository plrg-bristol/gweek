...
machine and steps it for a fixed quota of steps. If the machine has not
terminated within the quota, it is re-enqueued together with any unexplored
branches. This strategy is both complete and fair, and is particularly effective
for programs that mix finite branching (explicit choice) with infinite branching
(logical variable narrowing).
